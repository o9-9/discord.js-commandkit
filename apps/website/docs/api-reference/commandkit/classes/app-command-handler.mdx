...
<MemberInfo kind="method" type={`(data: <a href='/docs/api-reference/commandkit/interfaces/middleware#middleware'>Middleware</a>[]) => `}   />

Adds external middleware data to be loaded.
### addExternalCommands

<MemberInfo kind="method" type={`(data: <a href='/docs/api-reference/commandkit/interfaces/command#command'>Command</a>[]) => `}   />
...
<MemberInfo kind="method" type={`(data: <a href='/docs/api-reference/commandkit/interfaces/loaded-command#loadedcommand'>LoadedCommand</a>[]) => `}   />
